...
#define Nb 4
#define Nr 10
#define Nk 4 // other values 6,8
#define debug 0

static word rcon[] = {0x00000000,
                      0x001000000, 0x02000000, 0x04000000, 0x08000000,
...
void AddRoundKey(byte state[4][Nb], word *w, byte round);
...
void invCypher(byte *in, byte *out, word *w);
